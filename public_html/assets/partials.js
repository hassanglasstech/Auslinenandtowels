...
(function () {
  ...
  window.ALT_HEADER = function (active) {
    ...
    <header class="site-header">
      <div class="wrap">
        <nav class="nav-main left">
          ...
          <a href="collection.html?cat=towels-commercial">Towels</a>
          <a href="collection.html?cat=sheets-white">Bed Linen</a>
    ...
    <div class="mobile-drawer" id="mobileDrawer">
      ...
      <a href="collection.html?cat=towels-commercial">Commercial Towels</a>
      <a href="collection.html?cat=towels-coloured">Elegant Coloured Towels</a>
      <a href="collection.html?cat=towels-speciality">Speciality, Gym & Pool Towels</a>
      <a href="collection.html?cat=sheets-white">Bed Linen</a>
    ...
    <footer class="site-footer">
      <div class="wrap">
        ...
        <div>
          <h5>Collection</h5>
          <ul>
            <li><a href="collection.html?cat=towels-commercial">Towels</a></li>
            <li><a href="collection.html?cat=sheets-white">Bed Linen</a></li>
            <li><a href="collection.html?cat=quilts-all">Quilts &amp; Blankets</a></li>
            <li><a href="collection.html?cat=pillows-all">Luxury Pillows</a></li>
        ...
        <div>
          <h5>Griffith, NSW</h5>
          <p style="font-size:13px;line-height:1.7;color:#9b9dae;margin-top:12px;">
            <a href="tel:0414533449" style="color:#d4b568;">0414 533 449</a><br>
            <a href="mailto:info@auslinenandtowels.com.au" style="color:#d4b568;">Email us</a><br><br>

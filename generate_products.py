...
PRODUCTS = [
    ...
    p('ALU-BT-006-AQU', 'Elegant Coloured Bath Towel', 'Aqua', '70×140 cm', '500 GSM', '100% Cotton',
      'towels-bath', PH, moq='50', carton_qty='48', price=9.95,
    ...
    p('ALU-HT-003-BLK', 'Hand Towel', 'Black', '40×70 cm', '500 GSM', '100% Cotton',
    ...
    p('ALU-HT-003-CAM', 'Hand Towel', 'Camel', '40×70 cm', '500 GSM', '100% Cotton',
    ...
    p('ALU-HT-003-NVY', 'Hand Towel', 'Navy', '40×70 cm', '500 GSM', '100% Cotton',
    ...
    p('ALU-HT-003-CHR', 'Hand Towel', 'Charcoal', '40×70 cm', '500 GSM', '100% Cotton',
    ...
    p('ALU-FW-002-BLK', 'Face Washer', 'Black', '30×30 cm', '500 GSM', '100% Cotton',
    ...
    p('ALU-FW-002-CAM', 'Face Washer', 'Camel', '30×30 cm', '500 GSM', '100% Cotton',
    ...
    p('ALU-FW-002-NVY', 'Face Washer', 'Navy', '30×30 cm', '500 GSM', '100% Cotton',
    ...
    p('ALU-FW-002-CHR', 'Face Washer', 'Charcoal', '30×30 cm', '500 GSM', '100% Cotton',
    ...
    p('ALU-FW-004-AQU', 'Elegant Coloured Face Washer', 'Aqua', '30×30 cm', '500 GSM', '100% Cotton',
      'towels-face', PH, moq='100', carton_qty='200', price=1.20,
    ...
    p('ALU-BM-002-BLK', 'Bath Mat', 'Black', '50×80 cm', '720 GSM', '100% Cotton',
    ...
    p('ALU-BM-002-CAM', 'Bath Mat', 'Camel', '50×80 cm', '720 GSM', '100% Cotton',
    ...
    p('ALU-BM-002-NVY', 'Bath Mat', 'Navy', '50×80 cm', '720 GSM', '100% Cotton',
    ...
    p('ALU-BM-002-CHR', 'Bath Mat', 'Charcoal', '50×80 cm', '720 GSM', '100% Cotton',
    ...
    p('ALU-FL-002-CAM', 'Coloured Flat Sheet', 'Camel', 'Queen (255×265 cm)', '165 GSM', 'Cotton/Polyester Blend',
      'sheets-flat', PH,
      moq='10', carton_qty='', price=0,
      desc='165 GSM flat sheet in Camel — Queen size.',
      color_group='ALU-FL-002', parent_sku='ALU-FL-002', variant_name='Camel Queen', tag=''),
    p('ALU-FL-002-NVY', 'Coloured Flat Sheet', 'Navy', 'Queen (255×265 cm)', '165 GSM', 'Cotton/Polyester Blend',
      'sheets-flat', PH,
      moq='10', carton_qty='', price=0,
      desc='165 GSM flat sheet in Navy — Queen size.',
    ...
    p('ALU-FI-002-CAM', 'Coloured Fitted Sheet', 'Camel', 'Queen (153×203 cm)', '165 GSM', 'Cotton/Polyester Blend',
      'sheets-fitted', PH,
      moq='10', carton_qty='', price=0,
      desc='165 GSM fitted sheet in Camel — Queen size.',
    ...
    p('ALU-PC-002-CAM', 'Coloured Pillowcase', 'Camel', 'Standard (48×73 cm)', '165 GSM', 'Cotton/Polyester Blend',
      'sheets-pillow', PH,
      moq='20', carton_qty='', price=0,
    ...
    p('ALU-QC-002-CAM', 'Coloured Quilt Cover', 'Camel', 'Queen', '165 GSM', 'Cotton/Polyester Blend',
      'quilt-covers', PH,
      moq='5', carton_qty='', price=0,
      desc='165 GSM quilt cover in Camel — Queen size.',
      color_group='ALU-QC-002', parent_sku='ALU-QC-002', variant_name='Camel Queen', tag=''),
    p('ALU-QC-002-NVY', 'Coloured Quilt Cover', 'Navy', 'Queen', '165 GSM', 'Cotton/Polyester Blend',
      'quilt-covers', PH,
      moq='5', carton_qty='', price=0,
    ...
    p('ALU-QL-002-D', 'Classic Navy Reversible Quilt', 'Navy', 'Double/Queen', '300 GSM fill', 'Microfibre',
      'quilts-navy', PH,
      moq='5', carton_qty='', price=0,
      desc='300 GSM fill reversible navy quilt — Double/Queen size.',
      color_group='ALU-QL-002', parent_sku='ALU-QL-002', variant_name='Double/Queen', tag=''),
    ...
    p('ALU-BK-002', 'Premium Faux Wool Polar Fleece Blanket', 'Charcoal', 'Double/Queen', '300 GSM', 'Polar Fleece',
      'blankets-fleece', PH,
      moq='10', carton_qty='', price=0,
      desc='300 GSM faux wool polar fleece blanket in Charcoal.',
